...
void Heroes::PostLoad( void )
{
    ...
    if ( isControlAI() ) {
        AI::Get(GetKingdom().GetAiType()).HeroesPostLoad( *this );
    }
...
void Heroes::LevelUp( bool skipsecondary, bool autoselect )
{
    ...
    if ( isControlAI() )
        AI::Get(GetKingdom().GetAiType()).HeroesLevelUp( *this );
}
...
void Heroes::ActionNewPosition( const bool allowMonsterAttack )
{
    ...
    if ( isControlAI() )
        AI::Get(GetKingdom().GetAiType()).HeroesActionNewPosition( *this );
...
std::string Heroes::String( void ) const
{
    ...
    if ( isControlAI() ) {
        ...
        os << AI::Get(GetKingdom().GetAiType()).HeroesString( *this );
    }
