...
namespace
{
    ...
    {
    public:
        ObjectValueStorage( const Heroes & hero, const AI::Denis & ai, const double ignoreValue )
            : _hero( hero )
            , _ai( ai )
...
namespace AI
{
    ...
    double Denis::getHunterObjectValue( const Heroes & hero, const int index, const double valueToIgnore, const uint32_t distanceToObject ) const
    {
    ...
    double Denis::getFighterObjectValue( const Heroes & hero, const int index, const double valueToIgnore, const uint32_t distanceToObject ) const
    {
    ...
    double Denis::getObjectValue( const Heroes & hero, const int index, const double valueToIgnore, const uint32_t distanceToObject ) const
    {
    ...
    int AI::Denis::getPriorityTarget( const Heroes & hero, double & maxPriority, int patrolIndex, uint32_t distanceLimit )
    {
    ...
    void Denis::HeroesActionComplete( Heroes & hero )
    {
    ...
    bool Denis::HeroesTurn( VecHeroes & heroes )
    {
